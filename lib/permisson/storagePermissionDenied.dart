...
class StoragePermissionDenied extends StatefulWidget {
  const StoragePermissionDenied({super.key});

  @override
  State<StoragePermissionDenied> createState() =>
      _StoragePermissionDeniedState();
}

class _StoragePermissionDeniedState extends State<StoragePermissionDenied> {
