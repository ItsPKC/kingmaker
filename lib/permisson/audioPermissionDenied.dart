...
class AudioPermissionDenied extends StatefulWidget {
  const AudioPermissionDenied({super.key});

  @override
  State<AudioPermissionDenied> createState() => _AudioPermissionDeniedState();
}

class _AudioPermissionDeniedState extends State<AudioPermissionDenied> {
