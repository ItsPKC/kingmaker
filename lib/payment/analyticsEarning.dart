...
class AnalyticsEarning extends StatefulWidget {
  final Function pageNumberSelector;
  const AnalyticsEarning(this.pageNumberSelector, {super.key});

  @override
  State<AnalyticsEarning> createState() => _AnalyticsEarningState();
}

class _AnalyticsEarningState extends State<AnalyticsEarning> {
  final _controller = ScrollController();
  // var dayFilterAnalyticsEarning =
  //     prefs.get('dayFilterAnalyticsEarning') ?? '15d';
  ...
  //   dayFilterAnalyticsEarning = filter;
  //   await prefs.setString(
  //       'dayFilterAnalyticsEarning', dayFilterAnalyticsEarning);

  //   switch (filter) {
  //     case '7d':
  //       data = [];
  //       var tempdata = creatorInfo['ccHistory'].sublist(
  //           creatorInfo['ccHistory'].length - 7 > 0
  //               ? creatorInfo['ccHistory'].length - 7
  //               : 0);

  //       tempdata.forEach((element) {
  //         data.add([getDate(element), element['cc'] / 10000]);
  //       });
  //       break;
  //     case '15d':
  //       data = [];
  //       var tempdata = creatorInfo['ccHistory'].sublist(
  //           creatorInfo['ccHistory'].length - 15 > 0
  //               ? creatorInfo['ccHistory'].length - 15
  //               : 0);
  ...
  //       data = [];
  //       var tempdata = creatorInfo['ccHistory'].sublist(
  //           creatorInfo['ccHistory'].length - 30 > 0
  //               ? creatorInfo['ccHistory'].length - 30
  //               : 0);
  ...
  //       data = [];
  //       var tempdata = creatorInfo['ccHistory'].sublist(
  //           creatorInfo['ccHistory'].length - 90 > 0
  //               ? creatorInfo['ccHistory'].length - 90
  //               : 0);
  ...
  //     case 'Lifetime':
  //       data = [];
  //       var tempdata = creatorInfo['ccHistory'];
  ...
  // @override
  // void initState() {
  //   filterData(prefs.get('dayFilterAnalyticsEarning') ?? '15d');
  //   super.initState();
  // }
  ...
  @override
  void initState() {
    filterData(prefs.get('dayFilterAnalyticsEarning') ?? 'Lifetime');
    super.initState();
  }
                    ...
                    children: [
                      ListView(
                        ...
                        children: [
                          ...
                          ...dataEarning.reversed.toList().mapIndexed(
                            (index, element) {
                              var _changes = index == dataEarning.length - 1
                                  ? 0
                                  : (element[1] -
                                          dataEarning.reversed
                                              .toList()[index + 1][1]) *
                                      100 /
                                      dataEarning.reversed.toList()[index + 1]
                                          [1];
                              return Container(
                                height: 30,
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: FittedBox(
                                          child: Text(
                                            index == dataEarning.length - 1
                                                ? '-------'
                                                : dataEarning.reversed.toList()[
                                                            index + 1][1] ==
                                                        0
                                                    ? '-------'
